...
const InventoryMenu = preload("res://game/interface/menus/inventory/InventoryMenu.tscn")
const PlayerController = preload("res://game/actors/player/PlayerController.gd")
